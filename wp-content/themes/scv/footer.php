...
<footer>
	<div class="container">
		<div class="foot-top">
			<div class="foot-brand">
				<a href="<?php echo home_url('/'); ?>" class="brand">
					<img class="brand-logo skip-lazy" src="<?php echo get_template_directory_uri(); ?>/images/scv_logo_white-980.png" width="980" height="83" alt="VIETNAM CAMCOM" loading="eager" fetchpriority="high" decoding="sync" data-no-lazy="1" data-skip-lazy="1"/>
				</a>
		...
		<div class="foot-bottom">
			...
			<div class="socials">
                <div class="seal"><img class="skip-lazy" src="/wp-content/uploads/security-logo.png" alt="ISO/IEC 27001 logo" loading="eager" fetchpriority="high" decoding="sync" data-no-lazy="1" data-skip-lazy="1"/></div>
